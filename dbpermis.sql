...
-- Schema dbpermis
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dbpermis` DEFAULT CHARACTER SET utf8mb3 ;
USE `dbpermis` ;
...
-- -----------------------------------------------------
-- Table `dbpermis`.`sessions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbpermis`.`sessions` (
